...
class _LikeButtonState extends State<LikeButton> {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton.icon(
      ...
      icon: Icon(
        isLiked ? Icons.favorite : Icons.favorite_border, // Affiche l'icône en fonction du like
        color: Colors.red, // Couleur selon le statut du like,
      ),
      label: Text("${widget.likeNumber}", style: TextStyle(color: Colors.black),),
